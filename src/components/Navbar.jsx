...
export default function Navbar() {
  ...
  return (
    ...
    <nav
      className={`fixed top-0 w-full z-50 transition-colors duration-300 ease-in-out ${isMobileMenuOpen ? "bg-transparent" : "bg-[#F7F7F5]/80 backdrop-blur-md"}`}
    >
      {/* Top Bar Container */}
      <div className="flex justify-between items-center px-6 md:px-12 py-6 w-full max-w-screen-2xl mx-auto relative z-50">
        ...
        <div className="hidden md:flex items-center space-x-12">
          ...
          <NavLink className={linkClass} to="/enquiry">
            Enquiry
          </NavLink>
        </div>
      ...
      >
        ...
        {/* Added here */}
        <NavLink className={mobileLinkClass} to="/catalog">
          Catalog
        </NavLink>
        <NavLink className={mobileLinkClass} to="/clients">
          Clients
        </NavLink>
        <NavLink className={mobileLinkClass} to="/enquiry">
          Enquiry
        </NavLink>
        <Link
          to="/enquiry"
